...
def register():
    ...
    page_title       = 'Register - Eventually design coded in Flask | AppSeed App Generator'
    page_description = 'HTML5 Up Eventually design coded in Flask Microframework, registration page.'
...
def login():
    ...
    page_title       = 'Login - Eventually design coded in Flask | AppSeed App Generator'
    page_description = 'HTML5 Up Eventually design coded in Flask Microframework, login page.'
